package life.majiang.community.util.aliyunoss;
...
public class AliyunOSSClientUtil {
     ...
     * 上传图片至OSS
     * @param ossClient  oss连接
     * @param multipartFile 从前端的name得到的File，可以获取输入流和图片的名称
     * @param bucketName  存储空间
     * @param folder 模拟文件夹名 如"qj_nanjing/"
     * @return String 返回的唯一MD5数字签名
     * */
    public static  String uploadObject2OSS(MultipartFile multipartFile,OSSClient ossClient, String bucketName, String folder) {
    ...
    public static String getImgUrl(String fileUrl) {
        if (!StringUtils.isEmpty(fileUrl)) {
            ...
            String url =  getUrl(FOLDER + split[split.length - 1]);
//                log.info(url);
